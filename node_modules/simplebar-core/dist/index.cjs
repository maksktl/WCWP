...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('lodash/debounce.js'), require('lodash/throttle.js'), require('can-use-dom')) :
    typeof define === 'function' && define.amd ? define(['lodash/debounce.js', 'lodash/throttle.js', 'can-use-dom'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SimpleBarCore = factory(global._.debounce, global._.throttle, global.canUseDOM));
})(this, (function (debounce, throttle, canUseDOM) { 'use strict';
